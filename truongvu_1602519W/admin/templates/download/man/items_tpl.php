    ...
    <tbody>
        ...
        <?php if($config_list=='true'){?>
          <td align="center">
            <?php
              $d->reset();
              $sql = "select ten_vi from table_download_list where id='".$items[$i]['id_list']."'";
        ...
        <td>
            ...
            <a href="index.php?com=download&act=edit&id=<?=$items[$i]['id']?>&type=<?=$_GET['type']?>&id_list=<?=$items[$i]['id_list']?>" class="tipS SC_bold"><?=$items[$i]['ten_vi']?></a>
        ...
        <td class="actBtns">
            ...
            <a href="index.php?com=download&act=edit&id=<?=$items[$i]['id']?>&type=<?=$_GET['type']?>&id_list=<?=$items[$i]['id_list']?>" title="" class="smallButton tipS" original-title="Sửa danh mục"><img src="./images/icons/dark/pencil.png" alt=""></a>

            <a href="" onclick="CheckDelete('index.php?com=download&act=delete&id=<?=$items[$i]['id']?>&id_list=<?=$items[$i]['id_list']?>&type=<?=$_GET['type']?>'); return false;" title="" class="smallButton tipS" original-title="Xóa danh mục"><img src="./images/icons/dark/close.png" alt=""></a>
