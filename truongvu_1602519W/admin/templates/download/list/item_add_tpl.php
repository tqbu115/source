...
<div class="control_frm" style="margin-top:25px;">
    ...
    <div class="bc">
        ...
        <ul id="breadcrumbs" class="breadcrumbs">
        	...
        	<li><a href="index.php?com=download&act=add_list<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span>Thêm <?=$title_main?></span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=download&act=save_list<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
	...
	<div class="widget">
		...
		<div class="formRow">
			...
			<div class="mt10"><img src="<?=_upload_download.$item['thumb']?>"  alt="NO PHOTO" width="40" /></div>
		...
		<div class="formRow lang_hidden lang_vi active">
			...
			<div class="formRight">
                ...
                <input type="text" name="name_vi" title="Nhập tên bitmart" id="name_vi" class="tipS validate[required]" value="<?=@$item['name_vi']?>" />
		...
		<div class="formRow lang_hidden lang_en">
			...
			<label>Bigmart (Tiếng anh)</label>

			<div class="formRight">

                <input type="text" name="name_en" title="Nhập tên Bigmart" id="name_en" class="tipS validate[required]" value="<?=@$item['name_en']?>" />
	...
	<div class="widget">
		...
		<div class="formRow">
			...
			<div class="formRight">
            	...
            	<a href="index.php?com=download&act=man_list<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="button tipS" original-title="Thoát">Thoát</a>
