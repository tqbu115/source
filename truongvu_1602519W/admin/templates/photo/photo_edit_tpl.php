...
<!-- 		<div class="title"><img src="./images/icons/dark/list.png" alt="" class="titleIcon" />
        ...
        <div class="formRow lang_hidden lang_<?=$l?> <?=$key==0?'active':''?>">
            ...
            <div class="formRight">
                  <div class="mt10"><img src="<?=_upload_hinhanh.$item['photo_'.$l]?>"  alt="NO PHOTO" width="<?=_width_thumb?>" /></div>
            </div>
            <div class="clear"></div>
        </div>
        <div class="formRow lang_hidden lang_<?=$l?> <?=$key==0?'active':''?>">
        ...
        <div class="formRow lang_hidden lang_<?=$l?> <?=$key==0?'active':''?>">
            ...
            <div class="formRight">
                <input type="text" name="mota_<?=$l?>" title="Nhập Tên hình ảnh (<?=$config['langs'][$l]?>)" id="mota_<?=$l?>" class="tipS" value="<?=@$item['mota_'.$l]?>" />
            </div>
            <div class="clear"></div>
        </div>
        <?php } } ?>
        <?php  if($config_noidung == "true"){  ?>
            <div class="formRow lang_hidden lang_vi active">
                <label>Hotline</label>
                <div class="formRight">
                    <input type="text" name="noidung" title="Nội dung" id="noidung" class="tipS" value="<?=@$item['noidung']?>" />
                </div>
                <div class="clear"></div>
            </div>
        ...
        <div class="formRow lang_hidden lang_<?=$l?> <?=$key==0?'active':''?>">
            <label>hình ảnh (<?=$config['langs'][$l]?>):</label>
            <div class="formRight">
        ...
        <div class="formRow lang_hidden lang_<?=$l?> <?=$key==0?'active':''?>">
            <label>hình ảnh (<?=$config['langs'][$l]?>):</label>
            <div class="formRight">
                  <div class="mt10"><img src="<?=_upload_hinhanh.$item['icon_'.$l]?>"  alt="NO PHOTO" width="<?=_width_thumb_icon?>" /></div>
            </div>
            <div class="clear"></div>
        </div>
        <?php } } ?>
