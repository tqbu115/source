...
<form name="supplier" id="validate" class="form" action="index.php?com=place&act=save_city&curPage=<?=$_REQUEST['curPage']?>" method="post" enctype="multipart/form-data">
	<div class="widget">
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                <input type="text" name="phivanchuyen" title="Nhập giá bán" id="phivanchuyen" class="tipS conso validate[required]" value="<?=@$item['phivanchuyen']?>" />
            </div>
            <div class="clear"></div>
        </div>   
        <div class="formRow hidden">
            ...
            <div class="formRight">
                <input type="text" name="thoigiangiaohang" title="Nhập tên tỉnh thành" id="thoigiangiaohang" class="tipS validate[required]" value="<?=@$item['thoigiangiaohang']?>" />
            </div>
            <div class="clear"></div>
        </div> 
        <div class="formRow">
