  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    ...
    <thead>
      ...
      <tr>
        ...
        <?php } ?>
        <?php if($config_left == "true"){ ?>
        <td class="tb_data_small">Danh mục left</td>
        <?php } ?>
    ...
    <tbody>
       ...
       <td>
        ...
        <?php if($config_left == "true"){ ?>
        <td align="center">
        <a data-val2="table_<?=$_GET['com']?>_list" rel="<?=$items[$i]['dmleft']?>" data-val3="dmleft" class="diamondToggle <?=($items[$i]['dmleft']==1)?"diamondToggleOff":""?>" data-val0="<?=$items[$i]['id']?>" ></a> 
        </td>
        <?php } ?>
        <?php if($config_noibat == "true"){ ?>
         <td align="center">
