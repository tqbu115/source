...
<table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
  <thead>
    <tr>
      ...
      <?php } ?>
      <?php if($config_banchay2 == "true"){ ?>
        <td class="tb_data_small">Mới</td>    
      <?php } ?>
      <?php if($config_toptk == "true"){ ?>
        <td class="tb_data_small">Top tìm kiếm</td>    
      <?php } ?>
...
<?php if($size == "true"){ ?>
  <td align="center">
    <a href="index.php?com=tieude&act=man&type=color&id_parent=<?=$items[$i]['id']?>" title="" class="smallButton tipS" original-title="color"><img src="./images/icons/color/block.png" alt=""></a>
  </td>
<?php } ?>
<?php if($config_noibat == "true"){ ?>
  <td align="center">
...
<?php if($config_toptk == "true"){ ?>
  <td align="center">
    <a data-val2="table_<?=$_GET['com']?>" rel="<?=$items[$i]['toptk']?>" data-val3="toptk" class="diamondToggle <?=($items[$i]['toptk']==1)?"diamondToggleOff":""?>" data-val0="<?=$items[$i]['id']?>" ></a> 
  </td>
<?php } ?>
<td align="center">
