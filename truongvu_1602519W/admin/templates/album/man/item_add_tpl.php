...
<form name="supplier" id="validate" class="form" action="index.php?com=album&act=save<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
	...
	<div class="widget">
		...
		<div class="formRow">
			...
			<div class="mt10"><img src="<?=_upload_album.$item['photo']?>" max-width="500" alt="NO PHOTO" width="<?=_width_thumb?>" height="<?=_height_thumb?>" /></div>
				      ...
				      <?php if(count($ds_photo)!=0){?>       
				            ...
				            <?php for($i=0;$i<count($ds_photo);$i++){?>
				              ...
				              <div class="item_trich">
				                  ...
				                  <img class="img_trich" width="160" height="160" src="<?=_upload_album.$ds_photo[$i]['photo']?>" />
